...
export default function Administrador() {
    ...
    const handleSubmit = (event) => {
        ...
        if (funcionarioSelecionado) {
            axios.put(`http://7zbcjxjz.infinityfree.com/api/funcionario/${funcionarioSelecionado}/edit`, inputs).then(response => {
                console.log(response.data);
                getUsers();
            });
        } else {
            axios.post('http://7zbcjxjz.infinityfree.com/api/funcionario/save', inputs).then(response => {
                console.log(response.data);
                getUsers();
    ...
    function getUsers() {
        axios.get(`http://7zbcjxjz.infinityfree.com/api/funcionario/`).then(response => {
            console.log(response.data);
    ...
    const deleteUser = (cpf) => {
        axios.delete(`http://7zbcjxjz.infinityfree.com/api/funcionario/${cpf}/delete`).then(response => {
            console.log(response.data);
            getUsers();
            handleUnselectEmployee();
        });
    ...
    const deletePonto = (id) => {
        axios.delete(`http://7zbcjxjz.infinityfree.com/api/ponto/${id}/delete`).then(response => {
            console.log(response.data);
            getPontos();
        });
    };
